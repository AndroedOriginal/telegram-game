...
• Шах смертелен и мгновенный. Если ход ставит живого игрока в зону удара, тот сразу погибает: хода на спасение нет.
• 🔈 @игрок ставит шах @игрок.
• Ходить под чужой удар можно, но если после разрешения шаха ходивший сам остаётся под боем — он тоже погибает.
