...
Бой и шах
• Пешка бьёт только четыре соседние диагональные клетки (1, 3, 7, 9 вокруг себя), не всю диагональ.
• Слон, ладья и королева бьют по своим шахматным линиям до блокировки; конь — все 8 клеток буквы «Г».
• Шах смертелен и мгновенный. После хода проверяются зоны удара всех остальных живых фигур по получившейся позиции. Если ходивший встал на атакованную клетку — он сразу погибает: хода на спасение нет.
• 🔈 @игрок ставит шах @игрок.

Эволюция
• Точки эволюции — это спавны игроков. Нужно встать на точку, чтобы эволюционировать.
• Свою точку нельзя использовать, пока её не активирует другой игрок или пока вы сами не эволюционируете на чужой точке. После этого доступ владельца сохраняется навсегда, даже если точка переехала.
